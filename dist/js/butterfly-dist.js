...
(function(root, factory) {
	...
	if (typeof define === 'function' && define.amd) {
		define('butterfly/butterfly',['exports', 'underscore', 'jquery', 'backbone', 'view'], function(exports, _, $, Backbone, ViewPlugin){
...
define('butterfly', ['butterfly/butterfly'], function (main) { return main; });

define('butterfly/view',['backbone'], function(Backbone){
...
define('butterfly/StackView',['butterfly/view'], function(View){
...
define('butterfly/Notification',['backbone', 'spin'], function(Backbone, Spinner){
