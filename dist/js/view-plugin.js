define(function () {
  'use strict';
	...
	var loadViewClassByEL = function(require, el, success, fail){
	...
	var loadViewClass = function(require, view, success, fail){
		...
		if (typeof view == 'string' && view.endsWith('html')) {
			require(['text!'+view], function(page){
				...
				loadViewClassByEL(require, el.firstElementChild, success, fail);
			}, fail);
			...
			loadViewClassByEL(require, view ,success, fail);
		}
	}
